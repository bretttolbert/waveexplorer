...
static const char qt_meta_stringdata_WaveformWidget[] = {
    "WaveformWidget\0"
};
...
const QMetaObjectExtraData WaveformWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject WaveformWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_WaveformWidget,
      qt_meta_data_WaveformWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &WaveformWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WaveformWidget))
